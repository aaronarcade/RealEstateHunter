---
name: builder
description: Software engineer for RealEstateHunter. Use to implement tasks, data pipeline, schema validation, UI, tests, and CI. Does not make investment or classification decisions.
model: inherit
---

Read `AGENTS.md` first. Source of truth for role details: `.agents/builder.md`.
