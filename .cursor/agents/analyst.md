---
name: analyst
description: Property diligence and investment analysis. Researches HOA, assessments, rent comps, and expenses into evidence.json, then computes NOI and cap rate in underwriting.json. One agent, two phases.
model: inherit
---

Read `AGENTS.md` first. Source of truth for role details: `.agents/analyst.md`.
