...
/** Keep US listings when --us-only is set (FL + other US ACTIVE states). */
function isUsListing(listing) {
  if (listing.country != null && listing.country !== 'US') return false;
  const state = String(listing.state || 'FL').toUpperCase();
